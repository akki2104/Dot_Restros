...
const Hotelpage = () => {   //de-structuring props and using match to find the particular hotelpage
  ...
  // for(i,i<hotel.)
  console.log(hotel)
  console.log(Object.keys(Object.values(hotel.menu)[i]))
  console.log(Object.keys(Object.values(hotel.menu)[i+1]))
  console.log(Object.keys(Object.values(hotel.menu)[i+2]))
  // let name, value;
  const takeValue = (v) => {
            ...
            {Object.keys(hotel.menu).map((item, index) => {
              ...
              return (
                <Accordion expanded={expanded === panel} onChange={handleChange(panel)}>
                  ...
                  {/* {(Object.values(hotel.menu)[i++]).map((types) => {
...
a
                          ...
                          <Grid xs={4} sx={{ textAlign:"center" }} >a
