...
const Flyer = () => {
  return (
    <>
      <Box className='flyer_main' sx={{ backgroundColor: '#282828', width: 'auto', height: "400px", flexGrow: 1, display: { xs: 'none', sm: 'flex' }, justifyContent: 'center',alignItems:'center' }} >
        ...
        <div
          component="form"
          style={{ backgroundColor:'#fff', color:'red' ,p: '2px 4px', display: 'flex', alignItems: 'center', width: '40%',height:'60px',position:'absolute' ,marginTop:'3%',zIndex:2,border:'1.7px solid',borderColor:'#282828' }}
        >
